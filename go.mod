module github.com/zero-gravity-labs/zgda
...
require (
	...
	github.com/zero-gravity-labs/zerog-storage-client v0.1.1
	github.com/zero-gravity-labs/zgda/api v0.0.0
...
replace github.com/zero-gravity-labs/zgda/api => ./api
