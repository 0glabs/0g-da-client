...
type DisperserVars struct {
	...
	DISPERSER_SERVER_ZGDA_SERVICE_MANAGER string
...
type BatcherVars struct {
	...
	BATCHER_ZGDA_SERVICE_MANAGER string
...
type OperatorVars struct {
	...
	NODE_ZGDA_SERVICE_MANAGER string
...
type RetrieverVars struct {
	...
	RETRIEVER_ZGDA_SERVICE_MANAGER string
...
type ChurnerVars struct {
	...
	CHURNER_ZGDA_SERVICE_MANAGER string
